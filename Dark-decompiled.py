    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open http://termux.id/')
                time.sleep(2)
                menu()
